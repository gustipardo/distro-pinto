...
El repositorio ha sido configurado con Github Actions las cuales verifican que al hacer un commit no se encuentren errores en la build, en los test del backend o en el linter del código antes de permitir a Vercel que lleve a produccion el commit.
### Instalación
